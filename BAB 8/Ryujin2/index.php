...
<body>
	<div class="container">
		<header>
			<nav>
				<div class="Logo">
				<img src="assets/Ryu.png" alt="" width="150" Weight="75" />
				</div>
				...
				<ul>
					...
					<li><a href="login.php" class="btn_categories">Categories</a></li>
		...
		<main>
				...
				<div class="modal-dialog" onclick="event.stopPropagation()">
					<div class="modal-content">
						<div class="modal-header">
							<h1 class="modal-title " style="color:  #58e697;">Formulit Pembayaran</h1>
			...
			<div id="myModal2" class="modal-container" onclick="tutupModal2()">
				<div class="modal-dialog" onclick="event.stopPropagation()">
					<div class="modal-content">
						<div class="modal-header">
							<h1 class="modal-title" style="color:  #58e697;">Data Transaksi</h1>
